  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[120] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        {step === 'cart' && (
          <div className="p-8">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Review Your Order</h2>
        ...
        {step === 'payment' && (
          <div className="p-8">
            <div className="flex justify-between items-start mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Pay: ${cartTotal.toFixed(2)}</h2>
            ...
            {/* Payment Methods */}
            <div className="mb-8">
              <h3 className="font-semibold mb-4 text-gray-900 dark:text-white text-lg">Select Payment Method:</h3>
