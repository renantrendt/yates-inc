    ...
    <>
      ...
      {showConfirm && (
        <>
          ...
          />
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 rounded-xl p-6 z-[101] w-[400px] max-w-[90vw] shadow-2xl border border-purple-500">
